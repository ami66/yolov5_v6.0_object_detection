...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='weight/HK_idcard_v6x_best_v2.0.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default='test/img', help='file/dir/URL/glob, 0 for webcam')
