...
if __name__ == "__main__":
    ...
    model,ini_model=load_model(device=device,weights='./weight/bank_card_v6x_best_v1.0.pt', data_conf='./config/custom_data.yaml',  half=is_half)
    s=time.time()
    result=predict(image=img0,model=model,ini_model=ini_model,device=device,half=is_half)
    e=time.time()
