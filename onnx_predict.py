...
class yolov5():
    def __init__(self, yolo_type, confThreshold=0.5, nmsThreshold=0.5, objThreshold=0.5):
        ...
        self.classes = ['name_cn','name_en','name_code','birthday','sex','type','issue_date','closing_date','id_number']
...
if __name__ == "__main__":
    ...
    parser.add_argument("--imgpath", type=str, default='test/img/aug_1_HK_IDcard_v1_1.jpg', help="image path")
    parser.add_argument('--net_type', default='HK_idcard_v6x_best_v2.0', choices=['yolov5s', 'yolov5l', 'yolov5m', 'yolov5x'])
